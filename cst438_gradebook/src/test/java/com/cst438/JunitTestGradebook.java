...
public class JunitTestGradebook {
	...
	public static final int TEST_ASSIGNMENT_ID = 55;
	public static final String TEST_ASSIGNMENT_NAME = "TEST";
	public static final String TEST_ASSIGNMENT_DUEDATE = "2021-05-05";
	...
	public void addAssignment () throws Exception {
		...
		response = mvc.perform(MockMvcRequestBuilders.post("/gradebook").accept(MediaType.APPLICATION_JSON).content(asJsonString(assignment)).contentType(MediaType.APPLICATION_JSON)).andReturn().getResponse();

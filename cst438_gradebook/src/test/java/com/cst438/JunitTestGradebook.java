...
public class JunitTestGradebook {
	...
	public void addAssignment() throws Exception {
		...
		// then do an http get request for assignment 1
		response = mvc.perform(MockMvcRequestBuilders.post("/assignment?name=quiz1&dueDate=2021-09-06&courseId:999001").accept(MediaType.APPLICATION_JSON)).andReturn().getResponse();
